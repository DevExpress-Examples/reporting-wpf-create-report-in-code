...
#Region "#BindToData"
        Private Sub BindToData(ByVal report As XtraReport)
            ...
            Dim queryCategories As CustomSqlQuery = New CustomSqlQuery()
            ...
            Dim queryProducts As CustomSqlQuery = New CustomSqlQuery()
...
#Region "#CreateMasterReport"
        ...
        Private Sub CreateDetail(ByVal report As XtraReport)
            ...
            Dim labelDetail As XRLabel = New XRLabel()
...
#Region "#CreateDetailReport"
        Private Sub CreateDetailReport(ByVal report As XtraReport, ByVal dataMember As String)
            ...
            Dim detailReportBand As DetailReportBand = New DetailReportBand()
            ...
            Dim cellHeader1 As XRTableCell = New XRTableCell()
            cellHeader1.Text = "Product Name"
            Dim cellHeader2 As XRTableCell = New XRTableCell()
            ...
            Dim cellDetail1 As XRTableCell = New XRTableCell()
            cellDetail1.DataBindings.AddRange(New XRBinding() {New XRBinding("Text", report.DataSource, dataMember & ".ProductName")})
            Dim cellDetail2 As XRTableCell = New XRTableCell()
            cellDetail2.DataBindings.AddRange(New XRBinding() {New XRBinding("Text", report.DataSource, dataMember & ".UnitPrice", "{0:$0.00}")})
